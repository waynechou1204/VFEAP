...
public class VFIFE_BoundaryConditionLogical {
	...
	public VFIFE_BoundaryConditionLogical(Boolean bc_x_displacement_free,
			Boolean bc_x_rotation_free, Boolean bc_y_displacement_free,
			Boolean bc_y_rotation_free, Boolean bc_z_displacement_free,
			Boolean bc_z_rotation_free) {
		super();
