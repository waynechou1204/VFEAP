...
public class VFIFEMousePickBehavior extends PickMouseBehavior{
	...
	public void updateScene(int xpos, int ypos) {
        ...
        if (pickResult != null) {  
            ...
            if(shape.getUserData().getClass().equals(NodeInfo.class))
            {
            	float [] d = new float[3];
            	...
            	JOptionPane.showMessageDialog(panel,"node-id:"+((NodeInfo)shape.getUserData()).getNodeid()+"\n"+"node-name:"+((NodeInfo)shape.getUserData()).getNodename(),"info",JOptionPane.INFORMATION_MESSAGE);
            }
            else if(shape.getUserData().getClass().equals(BarInfo.class))
            {
            	...
            	JOptionPane.showMessageDialog(panel,"bar-id:"+((BarInfo)shape.getUserData()).getBarid(),"info",JOptionPane.INFORMATION_MESSAGE);
            }
        }
	}
